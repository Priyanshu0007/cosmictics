...
const Hero = () => {
  ...
  return (
    <div id="home"  className='container relative pt-6'>
        <Slideshow/>
        {/* <Image className='w-[100%] h-auto'  src="/hero/6.jpg " alt='Hero' width={1500} height={900}/> */}
        {close && <div className='z-10  hidden sm:block fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-white opacity-90 w-[-250px] h-[200px] space-y-3 lg:w-[300px] lg:h-[270px] lg:space-y-6 xl:w-[400px] xl:h-[300px] p-6 xl:space-y-8'>
